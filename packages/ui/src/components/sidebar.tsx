...
import { Separator } from "@internal-os/ui/components/separator";
import {
	Sheet,
	SheetContent,
	SheetDescription,
	SheetHeader,
	SheetTitle,
} from "@internal-os/ui/components/sheet";
import { Skeleton } from "@internal-os/ui/components/skeleton";
import {
	Tooltip,
	TooltipContent,
	TooltipTrigger,
} from "@internal-os/ui/components/tooltip";
import { useIsMobile } from "@internal-os/ui/hooks/use-mobile";
...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// shadcn persists the preference for seven days so server layouts can reuse it.
